$("#toSave").click(function() {
    ...
    params2["department"] = $("#department").val();
    ...
    if (
      ...
      panNull($("#department").val(), "科室不能为空") ||
    //   checkAddress($("#department").val(), "病区格式错误") ||
  ...
  $().ready(function() {
    ...
    var department = GetQueryString("department2");
